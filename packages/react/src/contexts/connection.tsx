...
import { sleep, CHAIN_ENV, DEFAULT_ENDPOINT, ENDPOINTS } from '@metaplex/utils'
import {
  Keypair,
...
export async function sendTransactionsWithManualRetry(
  ...
  let stopPoint = 0
  let tries = 0
  let lastInstructionsLength: number | undefined
  ...
  while (stopPoint < instructions.length && tries < 3) {
    ...
    if (lastInstructionsLength && instructions.length === lastInstructionsLength) tries++
    else tries = 0
